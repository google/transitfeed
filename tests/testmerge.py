...
class TestServicePeriodMerger(util.TestCase):
    ...
    def testUnion(self):
        ...
        CheckAttribs(self.sp1, self.fm.a_merge_map[self.sp1], fields, self.assertEquals)
        CheckAttribs(self.sp2, self.fm.b_merge_map[self.sp2], fields, self.assertEquals)
...
class TestAgencyMerger(util.TestCase):
    ...
    def testMerge(self):
        ...
        self.assertEquals(self.fm.a_merge_map[self.a1], self.fm.b_merge_map[self.a2])
        ...
        self.assertEquals(self.fm.a_merge_map[self.a1].agency_id, self.a1.agency_id)
    ...
    def testNoMerge_DifferentId(self):
        ...
        self.assert_(self.fm.a_merge_map[self.a1] in merged_schedule.GetAgencyList())
        ...
        self.assertEquals(self.fm.a_merge_map[self.a1].agency_id, self.a1.agency_id)
        self.assertEquals(self.fm.b_merge_map[self.a2].agency_id, self.a2.agency_id)
...
class TestStopMerger(util.TestCase):
    def setUp(self):
        ...
        self.s1 = transitfeed.Stop(30.0, 30.0, u"Andr\202", "s1")
    ...
    def testMerge(self):
        ...
        self.assertEquals(self.fm.a_merge_map[self.s1], self.fm.b_merge_map[self.s2])
        ...
        CheckAttribs(self.fm.a_merge_map[self.s1], self.s2, fields, self.assertEquals)
    ...
    def testParentRelationshipWithNewParentid(self):
        ...
        self.assertNotEquals(self.s2.stop_id, self.s2._migrated_entity.stop_id)
        self.AssertS1ParentIsS2()
...
class TestFareRuleMerger(util.TestCase):
    ...
    def testMerge(self):
        ...
        self.assertEquals(fare_rule_1.fare_id, self.fm.a_merge_map[self.f1].fare_id)
        self.assertEquals(fare_rule_1.route_id, self.fm.a_merge_map[self.r1].route_id)
